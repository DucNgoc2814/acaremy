  ...
  <div class="bg-white">
    <section class="py-6">
      <div class="container mx-auto px-4">
        ...
        <!-- Course Grid -->
        <div v-if="filteredCourses.length > 0" class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-2">
          <CourseCard 
            v-for="course in filteredCourses" 
            :key="course.id" 
            :course="course"
            :purchased-ids="purchasedCourseIds"
          ...
          <div class="flex flex-col md:flex-row gap-6">
            ...
            <div class="flex-1">
              ...
              <div class="bg-gray-50 rounded-lg p-4 mb-4">
                ...
                <div class="border-t border-gray-200 pt-2 mt-2">
                  <div class="flex justify-between items-center">
                    ...
                    <span class="font-bold text-lg text-blue-600">{{ formatCurrency(selectedCourse.price * 1.1) }}</span>
                  </div>
                </div>
              </div>
              ...
              <div class="bg-blue-50 p-4 rounded-lg mb-4">
                ...
                <div v-if="walletBalance < selectedCourse.price * 1.1" class="mt-2 text-red-600 text-xs flex items-start">
