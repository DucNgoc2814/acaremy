    ...
    <div class="max-w-6xl mx-auto">
      ...
      <div class="mb-6 border-b border-gray-200">
        <nav class="flex space-x-8" aria-label="Tabs">
          <button @click="activeTab = 'all'" class="py-4 px-1 border-b-2 font-medium text-sm"
          ...
          <button @click="activeTab = 'inProgress'" class="py-4 px-1 border-b-2 font-medium text-sm"
          ...
          <button @click="activeTab = 'completed'" class="py-4 px-1 border-b-2 font-medium text-sm"
      ...
      <div v-if="filteredCourses.length === 0" class="bg-gray-50 rounded-lg p-8 text-center">
        ...
        <router-link to="/courses"
          class="inline-flex items-center px-4 py-2 bg-indigo-600 text-white rounded-md text-sm font-medium hover:bg-indigo-700 transition-colors">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div v-for="course in filteredCourses" :key="course.id"
            ...
            <div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-4">
              <div class="flex items-center">
                ...
                <div v-if="course.progress === 100"
                  class="ml-2 bg-green-600 text-white text-xs font-medium px-2 py-1 rounded-full">
                  Hoàn thành
                </div>
              </div>
            </div>
          ...
          <div class="p-4">
            ...
            <!-- Action Button -->
            <router-link :to="`/courses/${course.slug}/learn`"
              class="mt-4 block w-full py-2 bg-indigo-600 text-white rounded-md text-sm font-medium text-center hover:bg-indigo-700 transition-colors">
...
const enrolledCourses = ref([
  ...
  {
    id: 2,
    slug: 'vue-js-xay-dung-ung-dung-spa-hien-dai',
  ...
  {
    id: 4,
    slug: 'api-development-voi-laravel',
