        ...
        <div class="md:w-2/3">
          ...
          <div v-else class="space-y-4">
            <div v-for="item in cartItems" :key="item.id"
              class="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300">
                  ...
                  <div class="flex flex-col sm:flex-row sm:items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <div class="mb-3 sm:mb-0">
                      <div v-if="hasDiscount(item)" class="flex items-center">
                        <p class="text-sm text-gray-500 line-through mr-2">{{ formatCurrency(getOriginalPrice(item)) }}
                        </p>
            ...
            <div class="flex justify-between items-center mt-6 py-4 border-t border-gray-200">
              <button @click="clearCart" class="text-sm text-red-600 hover:text-red-800 flex items-center">
        ...
        <div class="md:w-1/3 mt-8 md:mt-0">
          <div class="bg-gray-50 rounded-lg p-6 sticky top-20">
            ...
            <div v-if="cartItems.length > 0">
                ...
                <div class="border-t border-blue-100 pt-2 mt-2">
                  <div class="flex justify-between items-center">
                    ...
                    <span class="font-medium"
                      :class="{ 'text-red-600': walletBalance < (cartTotal + shippingFee), 'text-green-600': walletBalance >= (cartTotal + shippingFee) }">
              ...
              <div v-if="walletBalance < (cartTotal + shippingFee)"
                class="bg-red-50 border border-red-100 rounded-md p-3 mb-4">
                <div class="flex">
              ...
              <button v-if="walletBalance < (cartTotal + shippingFee)" @click="showDepositModal = true"
    ...
    <div v-if="showCheckoutSuccess" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4 p-6">
        <div class="text-center">
          ...
          <button @click="showCheckoutSuccess = false"
...
function checkout() {
  ...
  // Update wallet với loại giao dịch 'product_purchase' để phân biệt với mua khóa học
  walletStore.addTransaction('product_purchase', totalAmount, 'Thanh toán đơn hàng sản phẩm');
